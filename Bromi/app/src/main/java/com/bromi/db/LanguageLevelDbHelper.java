...
public class LanguageLevelDbHelper extends SQLiteOpenHelper {
    ...
    public static final String SQL_CREATE_ENTRIES = "CREATE TABLE " + Entries.TABLE_GERMAN + " (" + Entries._ID + " INTEGER PRIMARY KEY" + COMMA_SEP + Entries.COLUMN_LEVEL_ID + INTEGER_TYPE + COMMA_SEP + Entries.COLUMN_QUESTION_TYPE_ID + TEXT_TYPE + COMMA_SEP + Entries.COLUMN_FOREIGN_WORD + TEXT_TYPE + COMMA_SEP + Entries.COLUMN_TRANSLATED_WORD + TEXT_TYPE + ")";
